...
const material = new THREE.MeshStandardMaterial({
  ...
  // Environment
  envMap: envTexture,
  envMapIntensity: 1, // Only affects material's own envMap (not scene.environment since r163)
...
scene.environmentIntensity = 1; // Controls scene environment intensity (r163+)
